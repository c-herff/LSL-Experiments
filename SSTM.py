...
class App():
    ...
    def __init__(self, dot_time = 0.9, post_dot_time = 0.1, result_time = 1, alter_time = 1, postTrial_time = 0, post_alert_time = 0.5, practice_trials = 2, difficulty_level = 6, trials_per_difficulty = 15):
        ...
        if practice_trials != 0:
            self.label.configure(text="Starting with " + str(practice_trials) + " practice runs.\n Press <Space> to Start")
        else:
            self.label.configure(text="Press <Space> to Start")
        self.label.pack(expand=1)
		
        # Button initialisieren
        self.button = tk.Button(text="Cont.", font=('Helvetica bold', 22), state='disabled', command = self.next)
    ...
    def start(self, event):
        ...
        self.label.configure(text="Prepare!")
    ...
    def draw_grid(self):
        ...
        self.label.configure(text="Place the dots.", fg = "gray")
    ...
    def end(self):
        self.label.configure(text="Thank you! Experiment is finished.")
        self.label.pack(expand=1)
